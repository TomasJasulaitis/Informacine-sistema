<?php 
  session_start();
  $_SESSION['prefix'] = "../../";
  $_SESSION['currentPage'] = "assemblySelectionEdit";
	include_once '../header.php';
?>
    <h1 class="h2 text-center">Telefono komplektacijos pasirinkimo keitimas</h1>
    ...
    <select multiple class="form-control" id="exampleFormControlSelect2">
      ...
      <option class="selected">iPhone</option>
      ...
      <option>Nokia</option>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label for="pass">Įveskite ekrano dydį</label>
            <input type="password" class="form-control" id="pass">
        </div>
         <div class="form-group">
            <label for="pass">Įveskite telefono rezoliucijos dydį</label>
            <input type="password" class="form-control" id="pass">
        </div>
